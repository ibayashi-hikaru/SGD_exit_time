...
def draw(config_fn, sharpness_results, lr_results, batch_size_results, r_results):
    ...
    # ax1[0].errorbar(x, y, yerr=std, fmt='o') 
    # ax1[0].plot(x, m*x + c) 
    ...
    ax1[1].errorbar(x_2, y_2, yerr=log_std+np.sqrt(2)*np.sqrt(y_2)*log_std, fmt='o') 
    ...
    ax2[1].errorbar(x_2, y_2, yerr=log_std, fmt='o') 
    ...
    ax3[1].errorbar(x_2, y_2, yerr=log_std, fmt='o') 
    ...
    ax4[1].errorbar(x_2, y_2, yerr=log_std, fmt='o', capsize=100) 
    ...
    # ax4[2].errorbar(x_3, y_3, yerr=std*0, fmt='o') 
